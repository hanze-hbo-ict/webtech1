...
- [`beheer_cursist.py`](../bestanden/beheer_cursist.py)
- [`forms.py`](../bestanden/forms.py)
  
Een directory Templates met een vijftal HTML-bestanden:

- [`base.html`](../bestanden/base.html)
- [`home.html`](../bestanden/home.html)
- [`voegtoe_cur.html`](../bestanden/voegtoe_cur.html)
- [`toon_cur.html`](../bestanden/toon_cur.html)
- [`verwijder_cur.html`](../bestanden/verwijder_cur.html)
